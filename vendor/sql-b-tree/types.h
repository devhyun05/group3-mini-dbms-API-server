...
#define SQLBT_THREAD_LOCAL _Thread_local
#elif defined(__GNUC__) || defined(__clang__)
#define SQLBT_THREAD_LOCAL __thread
#else
#define SQLBT_THREAD_LOCAL
#endif
...
extern SQLBT_THREAD_LOCAL TableCache open_tables[MAX_TABLES];
extern SQLBT_THREAD_LOCAL int open_table_count;
